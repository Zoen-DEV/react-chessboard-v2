...
export type ChessboardProps = {
  ...
  /**
   * String with rgb or hex value to colour drawn arrows.
   * @default rgb(0,48,136)
   */
  altLeftClickArrowColor?: string;
  /**
   * String with rgb or hex value to colour drawn arrows.
   * @default rgb(21,120,27)
   */
  shiftLeftClickArrowColor?: string;
  /**
   * String with rgb or hex value to colour drawn arrows.
   * @default rgb(136,32,32)
   */
  shiftRightClickArrowColor?: string;
  /**
   * String with rgb or hex value to colour drawn arrows.
   * @default rgb(0,48,136)
   */
  shiftAltLeftClickArrowColor?: string;
  /**
   * String with rgb or hex value to colour drawn arrows.
   * @default rgb(255,170,0)
   */
  shiftAltRightClickArrowColor?: string;
  /**
  ...
  /**
   * User function that is run when a square is left clicked.
   * @default () => {}
   */
  onSquareLeftClick?: (square: Square) => any;
  /**
